...
namespace PerfectXL.VbaCodeAnalyzer.Parsing
{
    public class ErrorNode : VbaParseTree
    {
        ...
        public ErrorNode(IParseTree node) : base(node)
        {
            _error = node as IErrorNode;
        }

        public Interval SourceInterval => new Interval(_error.SourceInterval.a, _error.SourceInterval.b);
    }
}